...
const Header = ({ status }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-8 min-h-[55vh]">
      <header className="max-w-4xl mx-auto flex flex-col items-center text-center select-none animate-fade-in-up">
        <h1 className="serif-title text-4xl md:text-6xl font-medium tracking-tight text-[#fdf6e3]">
        ...
        <div className="mt-10 p-6 max-w-lg rounded-2xl warm-glass border border-white/5 shadow-2xl text-left select-text relative overflow-hidden group animate-fade-in-up">
